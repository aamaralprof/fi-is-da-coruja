...
const viewData={
 overview:{title:'Atmosfera da sala',description:'Escolha uma área para se aproximar ou mude a atmosfera.',scenes:{lilas:'assets/sala/sala-geral.png',azul:'assets/sala/sala-geral-azul.png'},blind:{x:27.8,y:0,w:18.1,h:42.3},alt:'Visão geral da Sala de Investigação'},
 shelf:{title:'Objetos da estante',description:'Escolha na bandeja e organize livros e a caixa Ideias nas prateleiras.',scenes:{lilas:'assets/sala/sala-estante-lilas.png',azul:'assets/sala/sala-estante-azul.png'},blind:{x:78.1,y:0,w:21.9,h:48.6},alt:'Estante aproximada da Sala de Investigação'},
 desk:{title:'Objetos da mesa',description:'Escolha na bandeja e organize os objetos sobre a mesa.',scenes:{lilas:'assets/sala/sala-mesa-aproximada.png',azul:'assets/sala/sala-mesa-azul.png'},blind:{x:0,y:0,w:17.5,h:66.8},alt:'Mesa aproximada da Sala de Investigação'},
 board:{title:'Mural de pistas',description:'Organize pistas, aproxime ideias e trace conexões.',scenes:{lilas:'assets/sala/sala-mesa-aproximada.png',azul:'assets/sala/sala-mesa-azul.png'},blind:{x:0,y:0,w:17.5,h:45.9},alt:'Mural da Sala de Investigação'}
};
const roomItems=[
...
const normalize=s=>{
 s=s||{};s.appearance=s.appearance||{rug:false,lights:'on'};s.appearance.pack=s.appearance.pack||'sofia';s.appearance.wall=s.appearance.wall||'lilas';s.appearance.rugX=Number.isFinite(s.appearance.rugX)?s.appearance.rugX:13;s.appearance.rugY=Number.isFinite(s.appearance.rugY)?s.appearance.rugY:67;s.appearance.blind=s.appearance.blind==='closed'?'closed':'open';s.appearance.time=s.appearance.time==='night'?'night':'day';s.appearance.roomLight=s.appearance.roomLight==='on'?'on':'off';s.roomItems=s.roomItems||{};s.paineis=s.paineis||{};
