...
const viewData={
 ...
 shelf:{title:'Objetos da estante',description:'Escolha na bandeja e organize livros e a caixa Ideias nas prateleiras.',scene:'assets/sala/sala-estante-aproximada.png',alt:'Estante aproximada da Sala de Investigação'},
 desk:{title:'Objetos da mesa',description:'Escolha na bandeja e organize os objetos sobre a mesa.',scene:'assets/sala/sala-mesa-aproximada.png',alt:'Mesa aproximada da Sala de Investigação'},
...
if(progresso('sofia-room-notebook-unlocked')==='unlocked')roomItems.push({id:'notebook_investigacao',name:'Notebook de Investigação',view:'desk',image:'assets/resultado-caminho-do-espelho.png',x:25,y:63,w:18,ratio:1.4});
